...
def is_valid_move(start, end, s_piece, turn, board):
    if s_piece is not None:
        ...
        #pawn
        if s_piece.lower() == 'p' and s_piece is not None:
        ...
        if s_piece.lower() == 'b':
            if abs(e_col - s_col) == abs(e_row - s_row) and ((turn == 'white' and not board[e_row][e_col].isupper()) or (
                    turn == 'black' and not board[e_row][e_col].islower())) and board[e_row][e_col].islower() is not None:
                # Check if there are no pieces between the start and end positions
...
def game_loop():
    ...
    while running:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 1:
                    ...
                    if selected_piece != ' ':
                        ...
                        for row in range(8):
                            for col in range(8):
                                if is_valid_move((row1, col1), (row, col), selected_piece, turn,
                                                 board) and is_future_proof(turn, board, (row1, col1), (row, col),
                                                                            selected_piece):
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if event.button == 1:
                    ...
                    if is_valid_move((row1, col1), (row2, col2), selected_piece, turn, board) and is_future_proof(turn,
                                                                                                                  board,
                                                                                                                  (row1,
                                                                                                                   col1),
                                                                                                                  (row2,
                        ...
                        attacked_squares = get_e_attacked_squares(turn, board)
                        if is_under_check(turn, attacked_squares, board) and not get_all_possible_moves(turn, board):
                            print('checkmate')
                            is_checkmate = True
                        elif not is_under_check(turn, attacked_squares, board) and not get_all_possible_moves(turn,
                                                                                                              board):
                            print('stalemate')
                            is_stalemate = True
                        elif is_under_check(turn, attacked_squares, board):
                            print("check")

                    elif turn == 'white':
                        if col2 == 6 and col1 == 4 and can_castle_kingside(turn, board, white_king_moved,
                            ...
                            turn = 'black'
                            attacked_squares = get_e_attacked_squares(turn, board)
                            if is_under_check(turn, attacked_squares, board) and not get_all_possible_moves(turn,
                                                                                                            board):
                                print('checkmate')
                                is_checkmate = True
                            elif not is_under_check(turn, attacked_squares, board) and not get_all_possible_moves(turn,
                        ...
                        elif col2 == 2 and col1 == 4 and can_castle_queenside(turn, board, white_king_moved,
                        ...
                        if col2 == 6 and col1 == 4 and can_castle_kingside(turn, board, black_king_moved,
                        ...
                        elif col2 == 2 and col1 == 4 and can_castle_queenside(turn, board, black_king_moved,
        ...
        if is_checkmate or is_stalemate:
            game_over(turn, is_checkmate, is_stalemate)
